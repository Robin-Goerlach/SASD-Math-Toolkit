...
Close every item marked `planned` in `BORLAND-V1-COMPATIBILITY.md`, especially the remaining FFT helpers and demonstration/sample applications. Complete or explicitly supersede the remaining item marked `partial`, currently the compact real-spectrum FFT convenience API.
