...
Alle noch offenen Punkte der englischen Kompatibilitätsmatrix schließen: insbesondere die verbleibenden FFT-Hilfsfunktionen und Demo-/Beispielanwendungen. Als verbleibender `partial`-Punkt muss derzeit noch die kompakte Real-Spektrum-FFT-Komfort-API abgeschlossen oder bewusst als durch eine allgemeinere API ersetzt dokumentiert werden.
