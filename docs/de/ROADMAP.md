...
Alle noch offenen Punkte der englischen Kompatibilitätsmatrix schließen: insbesondere die verbleibenden FFT-Hilfsfunktionen und Demo-/Beispielanwendungen. Zusätzlich müssen die verbleibenden mit `partial` gekennzeichneten Punkte, insbesondere benannte Least-Squares-Modelle und die kompakte Real-Spektrum-FFT-Komfort-API, abgeschlossen oder bewusst als durch allgemeinere APIs ersetzt dokumentiert werden.
