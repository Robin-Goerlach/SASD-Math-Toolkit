...
- Differential equations: fixed-step RK4 for scalar first-order, scalar second-order and first-order systems; adaptive RKF45; fourth-order Adams-Bashforth/Adams-Moulton predictor-corrector
