...
├── samples/
│   └── dotnet/                 # executable examples and graphical HTML/SVG demo
...
- Graphical demonstration: deterministic cross-platform HTML/SVG report generated by `Sasd.Math.Toolkit.Sample`
- Geometry seed: immutable `Vector2D`

The historical V1 functional catalog is now covered. Work on V1 therefore shifts toward handbook completion, API/documentation consistency and release hardening rather than adding further historical algorithms.
